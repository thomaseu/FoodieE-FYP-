...
import kotlinx.android.synthetic.main.activity_stripepayment.*
...
class stripepayment : AppCompatActivity() {
        ...
        private val stripe: Stripe by lazy { Stripe(applicationContext,"pk_test_51IMUQNCnvgNH86OU8XvRQQu5ceF62M1H4R2aQEyD5itQP2sh2Lj1i9ARnXMT65Ry9dRFOQdqqBQs53fKt5vXcTV100hEEKEy01" ) }
